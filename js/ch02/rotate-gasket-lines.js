...
function triangle( a, b, c ){
	//var k;
	var theta1=document.getElementById("b");
	theta=Math.PI*(parseFloat(theta1.value))/180.0;
...
function renderTriangles(){
 ...
 /* function selects(){
	var optionValue = document.getElementById("a");
	  
     var index=optionValue.selectedIndex ;
     numTimesToSubdivide=parseInt(optionValue.options[index].value); 
	// document.write(numTimesToSubdivide);
